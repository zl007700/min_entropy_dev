    ...
    product_state: {
      product_memory: {
        ...
        roadmap_pressure: [
          ...
          "Recent merged work has 1 low-reward round(s); prefer lower entropy before adding surface.",
          "Recent merged work has 1 high-entropy round(s); avoid broad stateful features.",
